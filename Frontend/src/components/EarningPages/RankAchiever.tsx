...
<<<<<<< HEAD
                  ...
                  <div
                    className={`rounded-2xl border p-5 shadow-sm ${
                      isDark
                        ? "border-[#B76E79]/30 bg-gradient-to-br from-[#B76E79]/15 to-transparent"
                        : "border-[#D99AA3]/40 bg-gradient-to-br from-[#FFE5E8] to-white"
                    }`}
                  >
                    <div
                      className={`mb-4 flex h-11 w-11 items-center justify-center rounded-xl ${
...
<<<<<<< HEAD
                ...
                <div
                  className={`mb-8 rounded-3xl border p-5 shadow-sm sm:p-7 ${
                    isDark
                      ? "border-white/10 bg-white/[0.035]"
                      : "border-gray-200 bg-white"
                  }`}
